                        ...
                        if(chapter.children.length > 0){
                            $.each(chapter.children, function(i_reading, reading){
                                ...
                                reading_content = reading_content +
                                    ...
                                    + reading_bookid + '&docno=' + reading_docno + '&usr='+ usr + '&grp=' + grp + '&sid='+ sid + '&page=1&fromHierarchical=tree' +'\';">?</a>&nbsp;&nbsp;<a class="doclink ' + 'docid-' + reading_id + '" href="#" onclick="javascript:parent.parent.frames[\'iframe-content\'].location = \''+reader_url+'?bookid='
...
//	    };
	...
	updateIndexForQuestionStatus(usr, grp, Object.keys(docIdSet));
	...
	function updateIndexForQuestionStatus(usr, grp, docids) {
	    var data = {
	        'docids': docids,
	        'usr': usr,
	        'grp': grp
 ...
 */   
	...
	var updateAllQuestionStatus = function() {
	  ...
	  updateIndexForQuestionStatus(usr, grp, parent.JSON.parse(allDocIds));
	  indexElement.classList.add('qShow');
	}
