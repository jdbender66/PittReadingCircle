...
<link rel="stylesheet" type="text/css" href="css/demo-bar.css" />
...
$(document).ready(function(){
                  $("#circle-btn").click(function(){
                                    var div=$("#iframe-sun");
                                    if(time === 0){
                                    div.animate({height:'400px',opacity:'1.0'},"slow");
                                    //document.write(time);
                                    time = time + 1;
                                    }
...
<button id="circle-btn">      Reading Circle      </button>
...
<div style="height:600px; width:450px; overflow:hidden;">
